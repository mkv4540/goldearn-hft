...
TEST_F(EnhancedRiskManagementTest, MultiplePositionsAndStrategies) {
    ...
    std::vector<Fill> fills = {{1001, "RELIANCE", 100, 2500.0, OrderSide::BUY, "market_making"},
...
TEST_F(EnhancedRiskManagementTest, PerformanceMetrics) {
    ...
    LOG_INFO("Risk check performance: {} checks, avg latency: {} ns", num_checks, avg_latency);
}
